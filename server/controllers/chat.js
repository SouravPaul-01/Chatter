...
const newGroupChat = TryCatch(async (req, res, next) => {
  ...
  emitEvent(req, ALERT, allMembers, `New Group Chat Created: ${name}`);
...
//     return next(
//       new ErrorHandler(
//         "You are not the creator of this chat so you can't add members",
//         403
//       )
//     );
//   }
...
//   emitEvent(req, ALERT, chat.members, `New Members Added: ${allUsersName}`);
...
//   if (files.length === 0)
//     return next(new ErrorHandler("No attachments found", 400));
//   if (files.length > 10)
//     return next(
//       new ErrorHandler("You can upload maximum 10 attachments at a time", 400)
//     );
